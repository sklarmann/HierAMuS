...
RVE = rectAngularRVE(L=1,b=1,h=1,nx=2,ny=4,nz=4,order=2)
...
mesh.getElementFormulations().addEL103_Timoshenko3D(num=1,E=E,G=G,A=A,Ix=Ix,Iy=Iy,Iz=Iz,ky=ky,kz=kz,geo=0,thermal=1,fe2=1,alpha=alpha,kappa=kappa,meshidDisp=meshIdDisp,meshidRot=meshIdRot,meshidTemp=meshIdTemp,dispOrder=dispOrder,rotOrder=rotOrder,tempOrder=tempOrder)
