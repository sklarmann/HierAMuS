...
p1 = gmsh.model.geo.addPoint(0,0,0,esize/4)
p2 = gmsh.model.geo.addPoint(L/2,0,0,esize)
p3 = gmsh.model.geo.addPoint(L/2,h,0,esize)
p4 = gmsh.model.geo.addPoint(0,h,0,esize/4)
...
fesys = HierAMuS.FEMPy(currPath, "gmshtestHDIV")
...
fesys.getMeshCommands().getElementFormulations().addEL205_HDivTest(1,100,disporder=disporder,stressorder=disporder-1,mode=2,meshiddisp=1,meshidstress=2,E=100,nu=0.3)
...
nt,b,c = gmsh.model.mesh.getNodes(0,p3,includeBoundary=False)
print(nt)
