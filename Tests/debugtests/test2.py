...
gm.addQuadrilateralFiniteElements(gmsh,1,surface,1)
...
fesys.getMeshCommands().getMaterialFormulations().addMA3_SmallStrainPlasticity(2, E=E, nu=nu, y0=E/100, yinf=0, xh=E/5, xd=0, eta=0)
...
fesys.getMeshCommands().getBoundaryConditions().singleLoad(fesys.getMeshCommands().getGeometryCommands().edgeType(), number=enums, meshId=1, load=[0,5,0], propnum=0,shapeorder=disporder)
gmsh.finalize()
