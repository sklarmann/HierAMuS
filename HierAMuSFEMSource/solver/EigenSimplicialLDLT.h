...
public:
  EigenSimplicialLDLT() = default;
  ;
  ~EigenSimplicialLDLT() override = default;
  ;
  ...
  auto getType() -> SolverTypes override {
    return SolverTypes::TypeEigenSimplicialLDLT;
  };

private:
  Eigen::SimplicialLDLT<Eigen::SparseMatrix<prec, 0, indexType>, Eigen::Lower,
