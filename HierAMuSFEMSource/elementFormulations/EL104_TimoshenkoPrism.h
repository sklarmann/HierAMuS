...
class EL104_TimoshenkoPrism : public GenericElementFormulationInterface<FiniteElement::LinearPrism> {
public:
  ...
  void setDegreesOfFreedom(PointerCollection &pointers,
                           FiniteElement::LinearPrism &elem) override;
...
private:
  ...
  Types::Matrix3X<prec> Hmatrix(const Types::VectorX<prec> &solution,
                                indexType numberBeamNodes);
  Types::Matrix3X<prec> Rmatrix(const Types::VectorX<prec> &solution,
                                indexType numberBeamNodes);
  Types::Vector3<prec>
  xo_prime_matrix(const Types::VectorX<prec> &shapeDerivative,
  ...
  Types::Matrix6X<prec> getNonBMatrix(
  ...
  Types::Vector6<prec> getstrain_Vector(
      const Types::VectorX<prec> &shapeDerivative,
      const Types::VectorX<prec> &shape, const Types::Matrix33<prec> &R01,
      const Types::Matrix33<prec> &R02, const Types::Matrix3X<prec> &coors,
  ...
  Types::MatrixXX<prec> getK_sigmaMatrix(
      const Types::VectorX<prec> &shapeDerivative,
      const Types::VectorX<prec> &shape, const Types::Matrix33<prec> &R01,
      const Types::Matrix33<prec> &R02, const Types::Matrix3X<prec> &coors,
