 ...
 *
 */
class LinearQuadrilateralData : public FacesDataInterface<4,4,LinearQuadrilateralData> {
public:
  LinearQuadrilateralData();
  ~LinearQuadrilateralData() override;
  ...
  static std::string getName() { return "Linear Quadrilateral"; }; 
